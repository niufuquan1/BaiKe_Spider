...
class Parser(object):
    ...
    >>> parser = Parser(opts)
    >>> htmlCont = '<dd class="lemmaWgt-lemmaTitle-title"><h1 >Python</h1></dd><div class="lemma-summary" label-module="lemmaSummary"><div class="para" label-module="para">Python</div></div>'
    >>> data = parser.getNewData("https://baike.baidu.com/item/Python/407313",htmlCont)
    >>> print(data['title'] == 'Python')
    True
    >>> print(data['summary'] == 'Python')
    True
    '''
    ...
    def parsePageForUrl(self, baseUrl, htmlCont, deep):
        ...
        try:
            ...
            while (deep != 1):
                ...
                for url in urls:
                    print(url)
                    _htmlCont = DownLoader(self.opts).getNextPage(url=url)  # 解析每一个url的网页内容
                    # print(_htmlCont)
